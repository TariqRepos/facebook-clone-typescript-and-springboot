    ...
    <div className='w-11/12 max-w-[700px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100'>
        ...
        <div className='mt-8'>
            ...
            <div className='mt-8 flex flex-col gap-y-4'>
                <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-purple-500 rounded-xl text-white font-bold text-lg'>Sign in</button>
                <button 
            ...
            <div className='mt-8 flex justify-center items-center'>
                ...
                <button 
                    ...
                    className='ml-2 font-medium text-base text-purple-500'>Sign up</button>
            </div>
        </div>
    </div>
  )
