...
const Auth: React.FC<Props> = ({ user, setAuthState, setUser }) => {
  return (
    <div className='flex w-full h-screen bg-blue-500'>
      ...
      <div className='hidden lg:flex mt-500 mx-auto h-full w-1/2 items-center justify-center bg-white'>
        <div className='h-96'>
          <img width={450} className='items-center justify-center' src="https://static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg" alt="fb_logo" />
      ...
      <div className='w-full m-20 flex items-center justify-center lg:w-1/2'>
        <Form user={user} setAuthState={setAuthState} setUser={setUser} />
      </div>
